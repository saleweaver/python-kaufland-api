...
class OrderUnits(Client):
    ...
    async def get_order_unit(self, id_order_unit, **kwargs) -> ApiResponse:
        ...
        """
        return await self._request(fill_query_params(kwargs.pop('path'), id_order_unit), params=kwargs, add_storefront=False)
    ...
    async def cancel_order_unit(self, id_order_unit, **kwargs) -> ApiResponse:
        ...
        return await self._request(fill_query_params(kwargs.pop('path'), id_order_unit), data=body, params=kwargs, add_storefront=False)
