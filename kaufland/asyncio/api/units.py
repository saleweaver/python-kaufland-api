...
class Units(Client):
    ...
    async def delete_unit(self, id_unit, **kwargs) -> ApiResponse:
        ...
        storefront: Storefront | required (query) Parameter to select the affected storefront
        """
        return await self._request(fill_query_params(kwargs.pop('path'), id_unit), params=kwargs, add_storefront=True)
    ...
    async def patch_unit(self, id_unit, **kwargs) -> ApiResponse:
        ...
        """
        body = kwargs.pop('body', None)
        return await self._request(fill_query_params(kwargs.pop('path'), id_unit), data=body, params=kwargs, add_storefront=True)
