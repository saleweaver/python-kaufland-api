...
class Warehouses(Client):
    ...
    async def delete_warehouse(self, id_warehouse, **kwargs) -> ApiResponse:
        ...
        """
        return await self._request(fill_query_params(kwargs.pop('path'), id_warehouse), params=kwargs, add_storefront=False)
    ...
    async def update_warehouse(self, id_warehouse, **kwargs) -> ApiResponse:
        ...
        """
        body = kwargs.pop('body', None)
        return await self._request(fill_query_params(kwargs.pop('path'), id_warehouse), data=body, params=kwargs, add_storefront=False)
