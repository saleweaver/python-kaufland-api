...
class OrderInvoices(Client):
    ...
    def upload_order_invoice(self, id_order, **kwargs) -> ApiResponse:
        ...
        return self._request(fill_query_params(kwargs.pop('path'), id_order), data=body, params=kwargs, add_storefront=False)
    ...
    def delete_order_invoice(self, id_order, id_invoice, **kwargs) -> ApiResponse:
        ...
        """
        return self._request(fill_query_params(kwargs.pop('path'), id_order, id_invoice), params=kwargs, add_storefront=False)
